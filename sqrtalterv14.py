...
# Version 1.4, supports all kinds of real number, and users can self-define the digits of the output, I also fixed all discovered vulnerbilities.
# Note: This change is the fatest one during the whole project.
